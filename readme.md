...
<img src="artifacts/cards/stats.svg" alt="AppSec &amp; DevSecOps Stats" height="270">
<img src="artifacts/cards/top-langs.svg" alt="Most Used Languages" height="270">
...
| [sbom_genform](https://github.com/geminishkv/sbom_genform) | CLI tool for generating and formatting SBOM (CycloneDX / SPDX) with CI/CD pipeline integration. | Python | [3.4](https://scorecard.dev/viewer/?uri=github.com/geminishkv/sbom_genform) |
...
| [geoip-tool](https://github.com/geminishkv/geoip-tool) | GeoIP-lookup mini-utility from the terminal and a Burp Suite plugin. Works via curl + jq without API keys. | Shell | [4.7](https://scorecard.dev/viewer/?uri=github.com/geminishkv/geoip-tool) |
<!-- PROJECTS-END -->
